...
export class GalleryForm {
  ...
  protected city = this.cities[0];
  protected multiCity = [this.cities[0]];
  ...
  protected readonly filteredCities = signal<{ name: string; code: string }[]>([]);
  protected search(e: { query: string }): void {
