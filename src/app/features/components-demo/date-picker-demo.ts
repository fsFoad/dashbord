...
export class DatePickerDemo {
  protected readonly calendar = signal<'auto' | 'jalali' | 'gregorian'>('auto');
  protected readonly calendarOptions = [
    { value: 'auto' as const, labelKey: 'pickerDemo.auto' },
    { value: 'jalali' as const, labelKey: 'pickerDemo.jalali' },
    { value: 'gregorian' as const, labelKey: 'pickerDemo.gregorian' },
  ];

  protected readonly single = signal<Date | null>(null);
  protected readonly range = signal<DateRange | null>(null);
  protected readonly dt = signal<Date | null>(null);
  protected readonly time = signal<string | null>(null);
  protected readonly timeRange = signal<TimeRange | null>(null);
}
