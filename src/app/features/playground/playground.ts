...
export class Playground {
  ...
  protected async confirmDemo(): Promise<void> {
    ...
    if (yes) this.toast.success('playground.confirm.done');
    else this.toast.info('playground.confirm.cancelled');
  }
