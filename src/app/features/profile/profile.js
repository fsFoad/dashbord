...
let Profile = class Profile {
    ...
    menuCollapsible = this.settings.menuCollapsible;
    twoFactor = signal(false);
    savingTwoFactor = signal(false);
    ...
    changePassword() {
        ...
        this.auth.changePassword(current, next).subscribe({
            ...
            error: (err) => {
                this.savingPass.set(false);
                this.passErrorKey.set(err instanceof HttpErrorResponse && err.status === 400
