...
import { TableConfig, DEFAULT_TABLE_CONFIG } from './data-table.model';
 ...
 */
export const TABLE_DEFAULTS = new InjectionToken<Required<TableConfig>>('TABLE_DEFAULTS', {
  providedIn: 'root',
 ...
 *   ]
 */
export function provideTableDefaults(config: Partial<TableConfig>): Provider {
  return {
