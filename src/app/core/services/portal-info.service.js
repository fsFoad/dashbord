...
const MOCK = {
    ...
    description: 'راهکار جامع تعریف، مسیردهی و انتشار سرویس‌های سازمانی با قابلیت اتصال مستقیم به منابع داده، اعمال سیاست‌های امنیتی پیشرفته و مانیتورینگ لحظه‌ای در یک پلتفرم متمرکز.',
    version: '1.6.01',
    features: [
        {
...
let PortalInfoService = class PortalInfoService {
    http = inject(HttpClient);
    get() {
        if (DATA_SOURCE.portalInfo)
            return of(MOCK);
        return this.http
            .get('/api/portal-info')
...
PortalInfoService = __decorate([
    Injectable({ providedIn: 'root' })
], PortalInfoService);
export { PortalInfoService };
