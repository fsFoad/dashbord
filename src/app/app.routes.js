...
export const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'projects',
                loadComponent: () => import('./features/projects/projects-table').then((m) => m.ProjectsTable),
                data: { titleKey: 'menu.projects.all' },
            },
            {
                path: 'projects/new',
                loadComponent: () => import('./features/projects/project-wizard').then((m) => m.ProjectWizard),
            ...
            },
            {
                ...
                loadComponent: () => import('./features/components-demo/form-builder/form-builder-demo').then((m) => m.FormBuilderDemo),
                data: { titleKey: 'menu.formBuilder' },
            },
            {
                path: 'components/gallery',
                loadComponent: () => import('./features/components-demo/gallery/components-gallery').then((m) => m.ComponentsGallery),
                data: { titleKey: 'menu.gallery' },
            },
            {
                path: 'components/date-picker',
                loadComponent: () => import('./features/components-demo/date-picker-demo').then((m) => m.DatePickerDemo),
            ...
            },
            {
                ...
                loadComponent: () => import('./features/projects-demo/projects-demo').then((m) => m.ProjectsDemo),
