...
let ApiRuleRegisterComponent = class ApiRuleRegisterComponent {
    route;
    transloco;
    ...
    partyBase = false;
    selectedRow = [];
    constructor(route, transloco, messagesApiFacadeService, apiGatewayService, cdr, _primengProgressBarService, notifierService) {
        this.route = route;
...
__decorate([
    Input()
], ApiRuleRegisterComponent.prototype, "inputRegister", void 0);
__decorate([
    Output()
], ApiRuleRegisterComponent.prototype, "close", void 0);
ApiRuleRegisterComponent = __decorate([
    Component({
...
export { ApiRuleRegisterComponent };
