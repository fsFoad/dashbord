...
let ApiRuleConditionComponent = class ApiRuleConditionComponent {
    route;
    ...
    ruleBase = false;
    constructor(route, messagesApiFacadeService, apiGatewayService, transloco, _primengProgressBarService) {
        this.route = route;
    ...
    ngOnInit() {
        ...
        if (this.inputCondition != undefined) {
            ...
            this.messagesApiFacadeService.getbyruleid(this.inputApiRule.ruleId).subscribe((a) => {
                ...
                this.ruleConditionsList.map((x) => x.status === 1 ? (x.status = true) : (x.status = false));
                for (let k = 0; k < this.ruleConditionsList.length; k++) {
                    this.ruleConditionsList[k] = Object.assign(this.ruleConditionsList[k], { row: k + 1 });
        ...
        this.apiGatewayService.currentApprovalStageApiName.subscribe((a) => {
            this._primengProgressBarService.hide();
            this.apiName = a;
        }, (error) => {
            this._primengProgressBarService.hide();
    ...
    onClose(event) {
        ...
        if (event == 'close') {
            ...
            this._primengProgressBarService.show();
            this.messagesApiFacadeService.getbyruleid(this.ruleId).subscribe((a) => {
                this._primengProgressBarService.hide();
                if (Array.isArray(a)) {
                    this.ruleConditionsList = a;
                }
...
__decorate([
    Output()
], ApiRuleConditionComponent.prototype, "close", void 0);
__decorate([
    Input()
], ApiRuleConditionComponent.prototype, "inputCondition", void 0);
__decorate([
    Input()
], ApiRuleConditionComponent.prototype, "inputClientCondition", void 0);
__decorate([
    Input()
], ApiRuleConditionComponent.prototype, "inputApiRule", void 0);
ApiRuleConditionComponent = __decorate([
    Component({
...
export { ApiRuleConditionComponent };
