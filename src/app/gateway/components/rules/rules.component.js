...
let RulesComponent = class RulesComponent {
    ...
    constructor(route, messagesApiFacadeService, apiGatewayService, primeng, _primengProgressBarService, transloco, notifierService) {
        this.route = route;
            ...
            this.messagesApiFacadeService.rulesearch(this.pagenoOutbound, this.pagesizeOutbound, this.name, this.statusCode, this.messageId, 1).subscribe((httpResponse) => {
                ...
                if (this.pagenoOutbound != 0 && this.pagenoOutbound != 1) {
                    for (let u = 0; u < this.ruleOutboundList.length; u++) {
                        this.ruleOutboundList[u] = Object.assign(this.ruleOutboundList[u], { row: u + startRow + 1 });
                    }
                    for (let u = 0; u < this.ruleOutboundList.length; u++) {
                        this.ruleOutboundList[u] = Object.assign(this.ruleOutboundList[u], { row: u + startRow + 1 });
                    }
                    ...
                    for (let u = 0; u < this.ruleOutboundList.length; u++) {
                        this.ruleOutboundList[u] = Object.assign(this.ruleOutboundList[u], { row: u + this.pagesizeOutbound + 1 });
                    }
                }
                else {
                    for (let u = 0; u < this.ruleOutboundList.length; u++) {
                        this.ruleOutboundList[u] = Object.assign(this.ruleOutboundList[u], { row: u + 1 });
                    }
                }
                this._primengProgressBarService.hide();
            ...
            this.messagesApiFacadeService.rulesearch(this.pagenoInbound, this.pagesizeInbound, this.name, this.statusCode, this.messageId, 0).subscribe((httpResponse) => {
                ...
                if (this.pagenoInbound != 0 && this.pagenoInbound != 1) {
                    for (let u = 0; u < this.ruleInboundList.length; u++) {
                        this.ruleInboundList[u] = Object.assign(this.ruleInboundList[u], { row: u + startRow + 1 });
                    }
                    for (let u = 0; u < this.ruleInboundList.length; u++) {
                        this.ruleInboundList[u] = Object.assign(this.ruleInboundList[u], { row: u + startRow + 1 });
                    }
                    ...
                    for (let u = 0; u < this.ruleInboundList.length; u++) {
                        this.ruleInboundList[u] = Object.assign(this.ruleInboundList[u], { row: u + this.pagesizeInbound + 1 });
                    }
                }
                else {
                    for (let u = 0; u < this.ruleInboundList.length; u++) {
                        this.ruleInboundList[u] = Object.assign(this.ruleInboundList[u], { row: u + 1 });
                    }
                }
                this._primengProgressBarService.hide();
                for (let k = 0; k < this.ruleList.length; k++) {
...
__decorate([
    Output()
], RulesComponent.prototype, "close", void 0);
__decorate([
    Input()
], RulesComponent.prototype, "inputRule", void 0);
