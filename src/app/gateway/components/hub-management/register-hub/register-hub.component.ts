...
export class RegisterHubComponent implements OnInit, OnChanges {
    ...
    onAcceptDbEngine(dbEngineId: any) {
        this.host = '';
        this.portHost = '';
        this.protocolHost = '';
    ...
    getClassByTitle(resultTestTitle: string): string {
    ...
    editFailover(failover) {
        ...
        const isDuplicate = this.failoverList.some(f =>
            f !== failover &&
                ...
                this.messagesApiFacadeService.datahubRegister(hubObj).subscribe(
                    (ne) => {
                        ...
                        if (tempfaloverObjsList != null) {
                            ...
                            const faloverObj: Failover = new Failover();
  ...
  *!/
    ...
    updateByHubId(hubId, changes) {
        this.allDbList = [];
        console.log(' this.allDbList1 ', this.allDbList);
        this.allDbList = this.allDbList.map(x =>
            x.hubId === hubId ? { ...x, ...changes } : x,
        );
        console.log(' this.allDbList2 ', this.allDbList);
    }
