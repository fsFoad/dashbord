...
let ResponseRateComponent = class ResponseRateComponent {
    ...
    chartWidth;
    entries;
    constructor(_primengProgressBarService, notifierService, apiGatewayService, messagesApiFacadeService, router, route) {
    ...
    validationRate() {
        debugger;
        if (!this.typeChart) {
            this.notifierService.showError({ detail: 'لطفا نوع گزارش را وارد نمائید! ' });
            return false;
        }
        else if (!this.fromdate) {
            this.notifierService.showError({ detail: 'لطفا تاریخ شروع را وارد نمائید! ' });
        }
        else if (!this.todate) {
            this.notifierService.showError({ detail: 'لطفا تاریخ پایان را وارد نمائید! ' });
        }
...
__decorate([
    ViewChild('chart')
], ResponseRateComponent.prototype, "chart", void 0);
ResponseRateComponent = __decorate([
    Component({
