...
let MultipleApisChartComponent = class MultipleApisChartComponent {
    ...
    handleChartClick(event) {
        ...
        if (this.chart && this.chart.chart) {
            ...
            const elements = chartInstance.getElementsAtEventForMode(event.originalEvent, 'nearest', { intersect: true }, true);
...
__decorate([
    Input()
], MultipleApisChartComponent.prototype, "inputMultipleApies", void 0);
__decorate([
    ViewChild('chart')
], MultipleApisChartComponent.prototype, "chart", void 0);
__decorate([
    ViewChild('chart2')
], MultipleApisChartComponent.prototype, "chart2", void 0);
__decorate([
    Output()
], MultipleApisChartComponent.prototype, "close", void 0);
MultipleApisChartComponent = __decorate([
    Component({
...
export { MultipleApisChartComponent };
