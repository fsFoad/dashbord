...
let FactorComponent = class FactorComponent {
    route;
    router;
    ...
    constructor(route, router, messagesApiFacadeService, apiGatewayService, _primengProgressBarService, transloco, notifierService) {
        this.route = route;
        this.router = router;
        ...
        this.messagesApiFacadeService
            ...
            for (let k = 0; k < this.factorList.length; k++) {
                if ('row' in this.factorList) {
                    ...
                    this.factorList[k] = Object.assign(this.factorList[k], { row: k + 1 });
                }
            }
        }, (error) => {
            this._primengProgressBarService.hide();
...
__decorate([
    Output()
], FactorComponent.prototype, "close", void 0);
