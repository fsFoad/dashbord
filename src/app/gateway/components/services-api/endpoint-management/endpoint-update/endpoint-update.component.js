...
let EndpointUpdateComponent = class EndpointUpdateComponent {
    route;
    ...
    constructor(route, messagesApiFacadeService, notifierService, _primengProgressBarService, apiGatewayService, transloco, validationsService) {
        this.route = route;
...
__decorate([
    Output()
], EndpointUpdateComponent.prototype, "close", void 0);
__decorate([
    Input()
], EndpointUpdateComponent.prototype, "inputUpdate", void 0);
EndpointUpdateComponent = __decorate([
    Component({
...
export { EndpointUpdateComponent };
