...
let EndpointRegisterComponent = class EndpointRegisterComponent {
    route;
    ...
    moduleBase;
    detailsBreadObject = [];
    constructor(route, messagesApiFacadeService, _primengProgressBarService, apiGatewayService, notifierService, transloco, validationsService) {
        this.route = route;
...
__decorate([
    Output()
], EndpointRegisterComponent.prototype, "close", void 0);
__decorate([
    Input()
], EndpointRegisterComponent.prototype, "inputRegister", void 0);
EndpointRegisterComponent = __decorate([
    Component({
...
export { EndpointRegisterComponent };
