...
let HeaderEndpointManagementComponent = class HeaderEndpointManagementComponent {
    route;
    transloco;
    cdr;
    ...
    updateFlag = false;
    tblFlag = false;
    apiEndpointHeaderFlag;
    endpointElementFlag = false;
    apiElementFlag = false;
    endpointList = [];
    ...
    constructor(route, transloco, cdr, messagesApiFacadeService, apiGatewayService, _primengProgressBarService) {
        this.route = route;
...
/!*
    ...
    ngOnInit() {
        ...
        if (this.inputEndpointHeader != undefined) {
            ...
            this.apiGatewayService.currentApprovalStageEndpoint.subscribe((msg) => {
                ...
                this.apiGatewayService.updateApprovalEndpointIdHeader(this.endpointid.toString());
                debugger;
                this.searchNotIsSystemByEndpointId();
                this.searchIsSystemByEndpointId();
            }, (error) => {
    ...
    searchNotIsSystemByEndpointId() {
        ...
        debugger;
        this.messagesApiFacadeService
            .getByEndpointIdNotIssystem(Number(this.endpointid), this.pagesizeNotIsSystem, this.pagenoNotIsSystem)
            .subscribe((response) => {
            debugger;
            this._primengProgressBarService.hide();
            let data = [];
            ...
            this.endpointNotIsSystemEndpointDetail =
                data.map((x, index) => ({
                    ...x,
                    row: (this.pagenoNotIsSystem * this.pagesizeNotIsSystem)
                        + index + 1,
                    status: x.status == 1,
                    isSystemEndpointDetail: x.isSystemEndpointDetail == 1
                }));
    ...
    searchIsSystemByEndpointId() {
        ...
        this._primengProgressBarService.show();
        this.messagesApiFacadeService
            .getByEndpointIdIssystem(Number(this.endpointid), this.pagesizeIsSystem, this.pagenoIsSystem)
            .subscribe((response) => {
            debugger;
            this._primengProgressBarService.hide();
            let data = [];
            ...
            this.endpointListIsSystemEndpointDetail =
                data.map((x, index) => ({
                    ...x,
                    row: (this.pagenoIsSystem * this.pagesizeIsSystem)
                        + index + 1,
                    status: x.status == 1,
                    isSystemEndpointDetail: x.isSystemEndpointDetail == 1
                }));
    ...
    searchNotIsSystemByApiId() {
        ...
        debugger;
        debugger;
        this.messagesApiFacadeService.endpointdetailByApi(this.apiId, this.pagenoIsSystem, this.pagesizeIsSystem, 0).subscribe((response) => {
            debugger;
            this._primengProgressBarService.hide();
            let data = [];
            if (Array.isArray(response.body)) {
    ...
    searchIsSystemByApiId() {
        ...
        this.firstIsSystem =
            this.pagenoIsSystem * this.pagesizeIsSystem;
        this._primengProgressBarService.show();
        this.messagesApiFacadeService.endpointdetailByApi(this.apiId, this.pagenoIsSystem, this.pagesizeIsSystem, 1)
            .subscribe((response) => {
            debugger;
            this._primengProgressBarService.hide();
            let data = [];
...
__decorate([
    Input()
], HeaderEndpointManagementComponent.prototype, "inputEndpointHeader", void 0);
__decorate([
    Input()
], HeaderEndpointManagementComponent.prototype, "inputApiEndpointHeader", void 0);
__decorate([
    Output()
], HeaderEndpointManagementComponent.prototype, "close", void 0);
HeaderEndpointManagementComponent = __decorate([
    Component({
...
export { HeaderEndpointManagementComponent };
