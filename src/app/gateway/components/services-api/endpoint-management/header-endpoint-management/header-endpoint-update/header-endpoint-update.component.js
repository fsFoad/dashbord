...
let HeaderEndpointUpdateComponent = class HeaderEndpointUpdateComponent {
    route;
    ...
    constructor(route, _primengProgressBarService, messagesApiFacadeService, apiGatewayService, transloco, notifierService, headerNameService) {
        this.route = route;
...
__decorate([
    Output()
], HeaderEndpointUpdateComponent.prototype, "close", void 0);
__decorate([
    Input()
], HeaderEndpointUpdateComponent.prototype, "inputUpdate", void 0);
HeaderEndpointUpdateComponent = __decorate([
    Component({
...
export { HeaderEndpointUpdateComponent };
