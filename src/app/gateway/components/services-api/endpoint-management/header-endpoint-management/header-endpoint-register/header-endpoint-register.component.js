...
let HeaderEndpointRegisterComponent = class HeaderEndpointRegisterComponent {
    route;
    ...
    constructor(route, messagesApiFacadeService, _primengProgressBarService, apiGatewayService, notifierService, transloco, headerNameService) {
        this.route = route;
        ...
        this.headerNameService = headerNameService;
    }
        ...
        if (this.validationRegister()) {
            ...
            if (this.input != undefined) {
                ...
                if (this.input.apiEndpointHeaderFlag) {
                    ...
                    this.apiGatewayService.currentApprovalStageEndpointIdHeader.subscribe((msg) => {
                        recordId = Number(msg);
                        levelId = 0;
                    }, (error) => {
                    });
                ...
                this.messagesApiFacadeService
                    .registerEndpointdetail(levelId, recordId, this.registerTemp)
                    .subscribe((a) => {
                    this._primengProgressBarService.hide();
                ...
                this._primengProgressBarService.show();
                this.messagesApiFacadeService.registerEndpointdetail(levelId, recordId, this.registerTemp).subscribe((a) => {
                    debugger;
                    this._primengProgressBarService.hide();
...
__decorate([
    Output()
], HeaderEndpointRegisterComponent.prototype, "close", void 0);
__decorate([
    Output()
], HeaderEndpointRegisterComponent.prototype, "closeCache", void 0);
__decorate([
    Input()
], HeaderEndpointRegisterComponent.prototype, "aggregatorInput", void 0);
__decorate([
    Input()
], HeaderEndpointRegisterComponent.prototype, "input", void 0);
__decorate([
    Input()
], HeaderEndpointRegisterComponent.prototype, "hubInput", void 0);
__decorate([
    Input()
], HeaderEndpointRegisterComponent.prototype, "cacheInput", void 0);
HeaderEndpointRegisterComponent = __decorate([
    Component({
...
export { HeaderEndpointRegisterComponent };
