...
let EndpointManagementComponent = class EndpointManagementComponent {
    route;
    transloco;
    ...
    totalRecords = 0;
    constructor(route, transloco, messagesApiFacadeService, apiGatewayService, _primengProgressBarService, accessDataSaveService, notifierService, primeng) {
        this.route = route;
    ...
    ngOnInit() {
        ...
        if (this.inputAccess != undefined) {
            ...
            this.messagesApiFacadeService.endpointbymoduleid(this.moduleId, this.pagesize, this.pageno).subscribe((res) => {
                this._primengProgressBarService.hide();
                this.totalRecords =
                ...
                this.endpointList = this.endpointList.map((x, index) => ({
                    ...x,
                    row: (this.pageno * this.pagesize)
                        + index + 1,
                    expanded: false,
                    status: x.status === 1,
                }));
                ...
                this.endpointList.forEach((item) => {
                    this.messagesApiFacadeService
                        ...
                        this.newEndpointList.push({
                            ...
                            destinationPortNumber: item.destinationPortNumber,
            ...
            this._primengProgressBarService.show();
            this.messagesApiFacadeService.SearchModuleById(this.moduleId).subscribe((resModul) => {
                this._primengProgressBarService.hide();
            ...
            let tempClientId;
            this.apiGatewayService.currentApprovalStageClientObject.subscribe((a) => {
            ...
            this.messagesApiFacadeService.endpointbyclientid(tempClientId).subscribe((res) => {
                ...
                this.endpointList.map((x) => x.status === 1
                    ? (x.status = true)
                    : (x.status = false));
                this.createEndpointFlag = this.disabelCheck();
                for (let k = 0; k < this.endpointList.length; k++) {
                    this.endpointList[k] = Object.assign(this.endpointList[k], { expanded: false });
                    this._primengProgressBarService.show();
                    debugger;
                    this.messagesApiFacadeService
            ...
            if (this.moduleBase) {
                ...
                this.messagesApiFacadeService.endpointbymoduleid(temp, this.pagesize, this.pageno).subscribe((res) => {
                    this._primengProgressBarService.hide();
                    this.totalRecords =
                        Number(res.headers.get('totalitems')) || 0;
                    const body = res.body ?? [];
  ...
  */
    ...
    showAllEndpointModule(endpoint) {
        ...
        this.messagesApiFacadeService.endpointbymoduleid(endpoint.moduleId, this.pagesize, this.pageno).subscribe((res) => {
            this._primengProgressBarService.hide();
            this.totalRecords =
                Number(res.headers.get('totalitems')) || 0;
            const body = res.body ?? [];
...
__decorate([
    Output()
], EndpointManagementComponent.prototype, "close", void 0);
__decorate([
    Input()
], EndpointManagementComponent.prototype, "inputEndpoint", void 0);
__decorate([
    Input()
], EndpointManagementComponent.prototype, "inputAccess", void 0);
__decorate([
    Input()
], EndpointManagementComponent.prototype, "inputClients", void 0);
EndpointManagementComponent = __decorate([
    Component({
...
export { EndpointManagementComponent };
