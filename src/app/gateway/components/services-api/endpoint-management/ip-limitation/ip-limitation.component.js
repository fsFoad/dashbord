...
let IpLimitationComponent = class IpLimitationComponent {
    route;
    notifierService;
    validationsService;
    ...
    accessBase;
    moduleBase;
    constructor(route, notifierService, validationsService, messagesApiFacadeService, transloco, _primengProgressBarService, apiGatewayService) {
        this.route = route;
    ...
    ngOnInit() {
        ...
        if (Array.isArray(this.inputIpLimit?.ipLimitList)) {
            ...
            this.ipAddress = this.inputIpLimit.ipLimitList.map((item) => ({
                name: item.ipAddress,
    ...
    onRegister() {
        ...
        if (!this.iplimit.length) {
            ...
            let completed = 0;
            const iplimitDtoArray = this.iplimit.map(ipItem => ({
    ...
    addList() {
        ...
        const newIp = { name: candidate, limitId: null };
...
__decorate([
    Output()
], IpLimitationComponent.prototype, "close", void 0);
__decorate([
    Input()
], IpLimitationComponent.prototype, "inputIpLimit", void 0);
IpLimitationComponent = __decorate([
    Component({
