...
let CashConfigComponent = class CashConfigComponent {
    apiGatewayService;
    ...
    messageSelector404Action$ = new Subject();
    apiNumber400;
    textMessage400;
    textENMessage400;
    icon500_val;
    ...
    constructor(apiGatewayService, messagesApiFacadeService, _primengProgressBarService, cd, notifierService, transloco, fb) {
    ...
    setupOtpInputs() {
        ...
        if (!container)
            return;
        this.otpInputs = Array.from(container.querySelectorAll('.p-inputotp-input'));
    ...
    validatorUpdateCache() {
        ...
        else if (!(this.form.controls['year'].value ||
    ...
    onChildSelectionCleared404(flag) {
        if (!flag)
            return;
        this.messageId4XX = null;
        this.selectedMessageId4XX = null;
...
__decorate([
    Input()
], CashConfigComponent.prototype, "inputApiCache", void 0);
CashConfigComponent = __decorate([
    Component({
