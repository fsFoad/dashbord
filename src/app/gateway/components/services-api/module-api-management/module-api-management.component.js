...
let ModuleApiManagementComponent = class ModuleApiManagementComponent {
    route;
    transloco;
    ...
    search() {
        ...
        if (!this.moduleTitle || this.moduleTitle == ' ') {
            ...
            this.messagesApiFacadeService
                ...
                this.moduleList.map((x) => x.status === 1
                    ? (x.status = true)
                    : (x.status = false));
            }, (error) => {
                this._primengProgressBarService.hide();
...
__decorate([
    Input()
], ModuleApiManagementComponent.prototype, "inputUpdate", void 0);
__decorate([
    Output()
], ModuleApiManagementComponent.prototype, "close", void 0);
ModuleApiManagementComponent = __decorate([
    Component({
...
export { ModuleApiManagementComponent };
