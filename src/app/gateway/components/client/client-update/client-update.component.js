...
let ClientUpdateComponent = class ClientUpdateComponent {
    ...
    fileContent = '';
    detailsBreadObject = [];
    constructor(route, _primengProgressBarService, messagesApiFacadeService, notifierService, apiGatewayService, transloco, validationsService) {
        this.route = route;
...
__decorate([
    Output()
], ClientUpdateComponent.prototype, "close", void 0);
__decorate([
    Input()
], ClientUpdateComponent.prototype, "updateClient", void 0);
