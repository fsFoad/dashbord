...
let ClientComponent = class ClientComponent {
    ...
    constructor(route, transloco, _primengProgressBarService, messagesApiFacadeService, apiGatewayService, notifierService, router, primeng) {
        this.route = route;
    ...
    ngOnInit() {
        ...
        this.messagesApiFacadeService.fetchallclient().subscribe((z) => {
    ...
    clear() {
        ...
        this.hiddenApikey = true;
        this._primengProgressBarService.show();
        this.messagesApiFacadeService.clientgetall().subscribe((z) => {
            this._primengProgressBarService.hide();
            if (Array.isArray(z)) {
                this.clientList = z;
            }
