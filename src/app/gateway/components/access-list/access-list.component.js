...
let AccessListComponent = class AccessListComponent {
    route;
    ...
    constructor(route, messagesApiFacadeService, _primengProgressBarService, primeng, encodingService, apiGatewayService, router, notifierService, transloco, cdr, accessDataSaveService) {
        this.route = route;
    ...
    onRowSelect(event) {
        ...
        if (this.selectedApi.indexOf(event.data) === -1)
            this.selectedApi.push(event.data);
        ...
        this.messagesApiFacadeService.rulesearch(this.pageno, this.pagesize, this.ruleName, null, null, 0).subscribe(httpResponse => {
            ...
            if (this.pageno != 0 && this.pageno != 1) {
                for (let u = 0; u < this.ruleList.length; u++) {
                    this.ruleList[u] = Object.assign(this.ruleList[u], { row: u + startRow + 1 });
                }
            }
            else if (this.pageno == 1) {
                for (let u = 0; u < this.ruleList.length; u++) {
                    this.ruleList[u] = Object.assign(this.ruleList[u], { row: u + this.pagesize + 1 });
                }
            }
            else {
                for (let u = 0; u < this.ruleList.length; u++) {
                    this.ruleList[u] = Object.assign(this.ruleList[u], { row: u + 1 });
                }
            }
            this._primengProgressBarService.hide();
...
__decorate([
    Output()
], AccessListComponent.prototype, "close", void 0);
__decorate([
    Input()
], AccessListComponent.prototype, "InputClient", void 0);
