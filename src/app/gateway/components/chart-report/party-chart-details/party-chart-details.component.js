...
let PartyChartDetailsComponent = class PartyChartDetailsComponent {
    chartsService;
    ...
    constructor(chartsService, _primengProgressBarService, translateService) {
...
*/
    ...
    ngOnInit() {
        ...
        this._primengProgressBarService.show();
        this.chartsService.getFetchAllParty().subscribe((response) => {
            this._primengProgressBarService.hide();
            this.partysData = response;
        }, (error) => {
            this._primengProgressBarService.hide();
    ...
    selectedParty() {
        this._primengProgressBarService.show();
        this.chartsService
            .getModulePieChartByParty(this.selectedPartyId, this.SelectedNumberOfDay)
            .subscribe((response) => {
            this._primengProgressBarService.hide();
            ...
            if (this.piChartData?.length > 0) {
                for (let i = 0; i < this.piChartData.length; ++i) {
                    this.partyDataForCharts.labels.push(this.piChartData[i].MODULETITLE);
                    this.partyDataForCharts.datasets[0].data.push(this.piChartData[i].PERCENTAGE);
                }
...
__decorate([
    Input()
], PartyChartDetailsComponent.prototype, "SelectedNumberOfDay", void 0);
PartyChartDetailsComponent = __decorate([
    Component({
...
export { PartyChartDetailsComponent };
