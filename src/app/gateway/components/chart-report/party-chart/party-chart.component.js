...
let PartyChartComponent = class PartyChartComponent {
    chartsService;
    translateService;
    ...
    constructor(chartsService, translateService, _primengProgressBarService) {
    ...
    ngOnChanges(changes) {
        if (changes.SelectedNumberOfDay && this.callTheService) {
            ...
            this.chartsService.getPiChart(this.SelectedNumberOfDay).subscribe((response) => {
...
__decorate([
    Input()
], PartyChartComponent.prototype, "SelectedNumberOfDay", void 0);
PartyChartComponent = __decorate([
    Component({
