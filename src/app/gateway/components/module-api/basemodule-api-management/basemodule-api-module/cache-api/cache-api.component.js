...
let CacheApiComponent = class CacheApiComponent {
    route;
    transloco;
    cd;
    ...
    partyTitle = '';
    title = '';
    constructor(route, transloco, cd, messagesApiFacadeService, _primengProgressBarService, apiGatewayService, primeng, confirmationService, notifierService) {
        this.route = route;
    ...
    refreshDataAndPreserveUnsavedItems(serverData) {
...
__decorate([
    Input()
], CacheApiComponent.prototype, "inputCacheApi", void 0);
__decorate([
    Output()
], CacheApiComponent.prototype, "close", void 0);
CacheApiComponent = __decorate([
    Component({
