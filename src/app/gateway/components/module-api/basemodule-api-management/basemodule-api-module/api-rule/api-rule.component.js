...
let ApiRuleComponent = class ApiRuleComponent {
    route;
    ...
    constructor(route, _primengProgressBarService, messagesApiFacadeService, apiGatewayService, primeng, transloco, notifierService) {
        this.route = route;
    ...
    clear() {
        ...
        this.messagesApiFacadeService.rulesearch(this.pageno, this.pagesize).subscribe((a) => {
        ...
        this.messagesApiFacadeService.rulesearch(this.pageno, this.pagesize, this.ruleName).subscribe(httpResponse => {
            ...
            if (this.pageno != 0 && this.pageno != 1) {
                for (let u = 0; u < this.ruleAttachList.length; u++) {
                    this.ruleAttachList[u] = Object.assign(this.ruleAttachList[u], { row: u + startRow + 1 });
                }
            }
            else if (this.pageno == 1) {
                for (let u = 0; u < this.ruleAttachList.length; u++) {
                    this.ruleAttachList[u] = Object.assign(this.ruleAttachList[u], { row: u + this.pagesize + 1 });
                }
            }
            else {
                for (let u = 0; u < this.ruleAttachList.length; u++) {
                    this.ruleAttachList[u] = Object.assign(this.ruleAttachList[u], { row: u + 1 });
                }
            }
            this._primengProgressBarService.hide();
        }, error => {
    ...
    showRules() {
        ...
        this.pageDescription = this.transloco.translate('hardCode.page') + ': ' + (this.pageno + 1);
        this._primengProgressBarService.show();
        this.messagesApiFacadeService.rulesearch(this.pageno, this.pagesize, this.ruleName).subscribe((c) => {
            debugger;
            this.nextBtnFlag = false;
            this._primengProgressBarService.hide();
    ...
    searchRule(apiId) {
        this._primengProgressBarService.show();
        this.messagesApiFacadeService.ruleFindByApiid(apiId).subscribe((a) => {
            this._primengProgressBarService.hide();
            if (Array.isArray(a)) {
                this.rulList = a;
            }
            ...
            this.rulList.map((x) => x.apiRuleStatus === 1 ? (x.apiRuleStatus = true) : (x.apiRuleStatus = false));
...
__decorate([
    Output()
], ApiRuleComponent.prototype, "close", void 0);
__decorate([
    Input()
], ApiRuleComponent.prototype, "inputApiRule", void 0);
ApiRuleComponent = __decorate([
    Component({
