...
let ProducedNodeComponent = class ProducedNodeComponent {
    apiGatewayService;
    transloco;
        ...
        this.messagesApiFacadeService.getapiproducednodebyapiid(this.apiId).subscribe((l) => {
            ...
            for (let k = 0; k < this.producedList.length; k++) {
                if ('row' in this.producedList) {
                    ...
                    this.producedList[k] = Object.assign(this.producedList[k], {
                        row: k + 1,
...
__decorate([
    Input()
], ProducedNodeComponent.prototype, "producedNodeApi", void 0);
__decorate([
    Output()
], ProducedNodeComponent.prototype, "close", void 0);
ProducedNodeComponent = __decorate([
    Component({
