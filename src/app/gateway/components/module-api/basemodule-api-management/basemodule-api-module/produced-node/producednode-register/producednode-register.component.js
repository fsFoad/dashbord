...
let ProducednodeRegisterComponent = class ProducednodeRegisterComponent {
    ...
    constructor(messagesApiFacadeService, notifierService, transloco, apiGatewayService, _primengProgressBarService) {
...
__decorate([
    Input()
], ProducednodeRegisterComponent.prototype, "producedInput", void 0);
__decorate([
    Output()
], ProducednodeRegisterComponent.prototype, "close", void 0);
ProducednodeRegisterComponent = __decorate([
    Component({
...
export { ProducednodeRegisterComponent };
