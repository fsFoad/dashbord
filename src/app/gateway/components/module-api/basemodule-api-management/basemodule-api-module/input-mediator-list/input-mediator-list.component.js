...
let InputMediatorListComponent = class InputMediatorListComponent {
    route;
    transloco;
    ...
    expandedGroups = {};
    treeNodes = [];
    constructor(route, transloco, _primengProgressBarService, messagesApiFacadeService, notifierService, apiGatewayService) {
        this.route = route;
    ...
    buildTree() {
        const groups = {};
        (this.inputMediatorsList || []).forEach((item) => {
            const key = item.mediatorTitle || 'سایر';
            if (!groups[key]) {
                groups[key] = [];
            }
    ...
    search(pageno, pagesize) {
        debugger;
        this.messagesApiFacadeService.getinputmediatorelement(this.input_inputMediatorsList.apiId, pageno, pagesize).subscribe((res) => {
            debugger;
            this.totalRecords = 0;
            this.firstIndex = 0;
            this.pagesize = 10;
...
__decorate([
    Output()
], InputMediatorListComponent.prototype, "close", void 0);
__decorate([
    Input()
], InputMediatorListComponent.prototype, "input_inputMediatorsList", void 0);
InputMediatorListComponent = __decorate([
    Component({
...
export { InputMediatorListComponent };
