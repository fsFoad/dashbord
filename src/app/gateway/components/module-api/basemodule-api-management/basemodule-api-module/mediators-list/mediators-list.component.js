...
let MediatorsListComponent = class MediatorsListComponent {
    route;
    transloco;
    ...
    fetchTable() {
        this._primengProgressBarService.show();
        this.messagesApiFacadeService.findbyapiid(this.apiId).subscribe((a) => {
            this._primengProgressBarService.hide();
            if (Array.isArray(a)) {
...
__decorate([
    Output()
], MediatorsListComponent.prototype, "close", void 0);
__decorate([
    Input()
], MediatorsListComponent.prototype, "inputMediators", void 0);
MediatorsListComponent = __decorate([
    Component({
