...
let apiHubComponent = class apiHubComponent {
    route;
    transloco;
    ...
    constructor(route, transloco, messagesApiFacadeService, _primengProgressBarService, apiGatewayService, primeng, confirmationService, notifierService) {
        this.route = route;
...
__decorate([
    Output()
], apiHubComponent.prototype, "close", void 0);
__decorate([
    Input()
], apiHubComponent.prototype, "inputApiHub", void 0);
apiHubComponent = __decorate([
    Component({
