...
let DetailListApiLog = class DetailListApiLog {
    ...
    apiId = null;
    logDate = null;
    constructor(messagesApiFacadeService, _primengProgressBarService, apiGatewayService) {
    ...
    ngOnInit() {
        ...
        this.apiGatewayService.currentApprovalStageObjLog.subscribe((res) => {
