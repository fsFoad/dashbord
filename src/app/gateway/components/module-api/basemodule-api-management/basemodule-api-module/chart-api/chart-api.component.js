...
let ChartApiComponent = class ChartApiComponent {
    route;
    ...
    selectedValue1 = 'val1';
    chartType;
    constructor(route, _primengProgressBarService, messagesApiFacadeService, notifierService, transloco, apiGatewayService) {
        this.route = route;
        ...
        if (this.day != null) {
            ...
            this.messagesApiFacadeService
                ...
                this.successDataList =
                    this.statusList[0].successData.map((data) => data.count);
                this.unSuccessDataList =
                    this.statusList[0].unSuccessData.map((data) => data.count);
                console.log(this.successDataList, 'successDataList');
                console.log(this.unSuccessDataList, 'unSuccessDataList');
                this.chatDataLine = {
...
__decorate([
    Output()
], ChartApiComponent.prototype, "close", void 0);
__decorate([
    Input()
], ChartApiComponent.prototype, "inputChart", void 0);
__decorate([
    ViewChild('chart')
], ChartApiComponent.prototype, "chart", void 0);
ChartApiComponent = __decorate([
    Component({
