...
let RequiredNodeComponent = class RequiredNodeComponent {
    apiGatewayService;
    transloco;
    ...
    constructor(apiGatewayService, transloco, messagesApiFacadeService, _primengProgressBarService) {
        ...
        this.messagesApiFacadeService.getapirequirednodebyapiid(this.apiId).subscribe((l) => {
            ...
            for (let k = 0; k < this.requirednodeList.length; k++) {
                if ('row' in this.requirednodeList) {
                    ...
                    this.requirednodeList[k] = Object.assign(this.requirednodeList[k], {
                        row: k + 1,
...
__decorate([
    Input()
], RequiredNodeComponent.prototype, "requiredNodeApi", void 0);
__decorate([
    Output()
], RequiredNodeComponent.prototype, "close", void 0);
RequiredNodeComponent = __decorate([
    Component({
