...
let SequenceRegisterComponent = class SequenceRegisterComponent {
    notifierService;
    transloco;
    apiGatewayService;
    confirmationService;
    ...
    constructor(notifierService, transloco, apiGatewayService, confirmationService, messagesApiFacadeService, _primengProgressBarService) {
    ...
    inputSequenceRegister;
    close = new EventEmitter();
    responseObjSequence = null;
    titleApiSecound = 'سرویس اولیه';
    messageSelector200Action$ = new Subject();
    messageSelector400Action$ = new Subject();
    messageSelector500Action$ = new Subject();
    titleApiDe;
    apiIdDe;
    apiIdOrg;
    apiTitleOrg;
    ...
    handleMessageSelected(type, message) {
    ...
    getSuffixForNodePlace(nodePlace) {
    ...
    matchingFirst() {
        ...
        let producedId = null;
        let requiredId = null;
        let nodeNameProduced = null;
        let nodePlaceProduced = null;
        let nodePathProduced = null;
        let nodePlaceRrequired = null;
        let nodeNameRrequired = null;
        let nodePathRrequired = null;
    ...
    setRecordDialogFirst(numberApi) {
        this.tempItemDialog = numberApi;
    }
    onCancel() {
        this.close.emit('close');
    }
    validationRegisterSequence() {
        debugger;
        if (!this.title) {
...
__decorate([
    Input()
], SequenceRegisterComponent.prototype, "inputSequenceRegister", void 0);
__decorate([
    Output()
], SequenceRegisterComponent.prototype, "close", void 0);
SequenceRegisterComponent = __decorate([
    Component({
...
export { SequenceRegisterComponent };
