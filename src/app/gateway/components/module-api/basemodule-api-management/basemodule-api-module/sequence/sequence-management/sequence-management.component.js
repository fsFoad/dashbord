...
let SequenceManagementComponent = class SequenceManagementComponent {
    apiGatewayService;
    transloco;
    ...
    fetchList(pageno, pagesize) {
        ...
        this.messagesApiFacadeService.getapisequencebyapiidv2(this.pageno, this.pagesize, this.apiId).subscribe((a) => {
            ...
            this.sequenceList.map((x) => x.status === 1
                ? (x.status = true)
                : (x.status = false));
            if (pageno != 0 && pageno != 1) {
                debugger;
                for (let u = 0; u < this.sequenceList.length; u++) {
                    this.sequenceList[u] = Object.assign(this.sequenceList[u], { row: u + startRow + 1 });
                    debugger;
                }
            }
            else if (pageno == 1) {
                debugger;
                for (let u = 0; u < this.sequenceList.length; u++) {
                    this.sequenceList[u] = Object.assign(this.sequenceList[u], { row: u + pagesize + 1 });
                    debugger;
                }
            }
            else {
                for (let u = 0; u < this.sequenceList.length; u++) {
                    this.sequenceList[u] = Object.assign(this.sequenceList[u], { row: u + 1 });
                    debugger;
                }
            }
            this.loading = false;
...
__decorate([
    Input()
], SequenceManagementComponent.prototype, "inputSequenceManagement", void 0);
__decorate([
    Output()
], SequenceManagementComponent.prototype, "close", void 0);
SequenceManagementComponent = __decorate([
    Component({
...
export { SequenceManagementComponent };
