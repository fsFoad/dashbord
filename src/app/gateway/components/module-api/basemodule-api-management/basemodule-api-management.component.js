...
import { ModuleApiUpdateComponent } from "../../services-api/module-api-management/module-api-update/module-api-update.component";
import { BasemoduleApiAddComponent } from "./basemodule-api-party-management/basemodule-api-add/basemodule-api-add.component";
...
let BasemoduleApiManagementComponent = class BasemoduleApiManagementComponent {
    route;
    transloco;
    ...
    constructor(route, transloco, messagesApiFacadeService, _primengProgressBarService, apiGatewayService, notifierService, primeng) {
        this.route = route;
        ...
        this.messagesApiFacadeService
            ...
            if (this.pageno != 0 && this.pageno != 1) {
                for (let u = 0; u < this.moduleList.length; u++) {
                    this.moduleList[u] = Object.assign(this.moduleList[u], { row: u + startRow + 1 });
                }
            }
            else if (this.pageno == 1) {
                for (let u = 0; u < this.moduleList.length; u++) {
                    this.moduleList[u] = Object.assign(this.moduleList[u], { row: u + this.pagesize + 1 });
                }
            }
            else {
                for (let u = 0; u < this.moduleList.length; u++) {
                    this.moduleList[u] = Object.assign(this.moduleList[u], { row: u + 1 });
                }
            }
        }, (error) => {
            this._primengProgressBarService.hide();
    ...
    showAdd() {
        ...
        this.messagesApiFacadeService
            ...
            this.partyList = data.map((item, index) => ({
                ...
                row: (this.pagenoParty * this.pagesizeParty) +
                    index +
                    1
            }));
    ...
    searchParty() {
        ...
        this.messagesApiFacadeService
            ...
            if (this.pagenoParty != 0 && this.pagenoParty != 1) {
                for (let u = 0; u < this.partyList.length; u++) {
                    this.partyList[u] = Object.assign(this.partyList[u], { row: u + startRowParty + 1 });
                }
            }
            else if (this.pagenoParty == 1) {
                for (let u = 0; u < this.partyList.length; u++) {
                    this.partyList[u] = Object.assign(this.partyList[u], { row: u + this.pagesizeParty + 1 });
                }
            }
            else {
                for (let u = 0; u < this.partyList.length; u++) {
...
BasemoduleApiManagementComponent = __decorate([
    Component({
...
export { BasemoduleApiManagementComponent };
