...
let ApiGatewayConstantsService = class ApiGatewayConstantsService {
    translateService;
    notifiSuccess = '';
    licenseInfoList = [];
    customerTypes = [];
...
ApiGatewayConstantsService = __decorate([
    Injectable({
        providedIn: 'root'
    })
], ApiGatewayConstantsService);
export { ApiGatewayConstantsService };
