 ...
 */
let SidebarProfile = class SidebarProfile {
    ...
    now = new Date();
    todayJalali = dateToJalali(this.now);
    /** e.g. «سه‌شنبه ۹ تیر» */
    jalaliDate = `${JALALI_WEEKDAYS_FULL[this.now.getDay()]} ${faDigits(this.todayJalali.d)} ${JALALI_MONTHS[this.todayJalali.m - 1]}`;
    season = (() => {
